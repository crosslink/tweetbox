 ...
 */
public class TwitterResponse implements java.io.Serializable, Comparable {
    ...
    public int compareTo(Object o2) throws ClassCastException {
        if (o2 instanceof TwitterResponse && this.getClass() == o2.getClass()) {
           Long id1 = null;
           Long id2 = null;
           if (this instanceof Status) {
               id1 = new Long(((Status)this).getId());
               id2 = new Long(((Status)o2).getId());
           }
           else if (this instanceof DirectMessage) {
               id1 = new Long(((DirectMessage)this).getId());
               id2 = new Long(((DirectMessage)o2).getId());
           }
           else if (this instanceof User) {
               id1 = new Long(((User)this).getId());
