...
public class MeshStyle {
    public static attribute MESH_BLUE:Color = Color.rgb(41,170,210,0.8);
    public static attribute MESH_RED:Color = Color.rgb(215,31,58,0.8);
    
    public attribute APPLICATION_BACKGROUND_FILL:Paint = LinearGradient {
        startX:0 startY:0 endX:0 endY: 1
        stops: [
            Stop { offset:0 color:MESH_BLUE},
    ...
    // status bar styles
    public attribute APPLICATION_STATUSBAR_FILL: Paint = Color.rgb(255,255,255,0.1);
