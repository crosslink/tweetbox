...
pack200 --repack dist\lib\JFXtras-0.2.jar
...
jarsigner -keystore "http://www.xs4all.nl/~mnankman/tweetbox/keystore" -verbose -keypass tweetbox -storepass tweetbox dist\lib\JFXtras-0.2.jar mnankman
